...
export default function About() {
  return (
    <>
      <Head>
        <title>About - Quizontal AI Background Remover</title>
        <meta name="description" content="Learn about our mission to make AI-powered background removal accessible to everyone, for free." />
      </Head>
